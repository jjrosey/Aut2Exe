...
Func _Main()
    ...
    ; Add keys with items
    DebugPrint('_AddItem("One", "Same")' & @TAB & _AddItem("One", "Same")
    _DebugPrint('_AddItem("Two", "Car")' & @TAB & _AddItem("Two", "Car"))
    DebugPrint('_AddItem("Three", "House")' & @TAB & _AddItem("Three", "House"))
    _DebugPrint('_AddItem("Three", "House")' & @TAB & _AddItem("Three", "House"))
    DebugPrint('_AddItem("Four", "Boat")' & @TAB & _AddItem("Four", "Boat"))
